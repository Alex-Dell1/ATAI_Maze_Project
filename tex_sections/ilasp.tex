...
The next step is to consider obstacles on the grid, as discussed in the "background knowledge" in (ref). Here the goal is to find a new normal rule that represent the concet of a "valid move", in a cell without obstacles.
